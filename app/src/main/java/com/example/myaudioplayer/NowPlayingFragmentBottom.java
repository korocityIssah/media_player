...
import static com.example.myaudioplayer.MainActivity.ARTIST_TO_FLAG;
import static com.example.myaudioplayer.MainActivity.PATH_TO_FLAG;
import static com.example.myaudioplayer.MainActivity.SHOW_MINI_PLAYER;
import static com.example.myaudioplayer.MainActivity.SONG_NAME_TO_FLAG;
                ...
                if (musicService != null) {
                    ...
                    editor.apply();
                        ...
                        if (path != null) {
                            ...
                            PATH_TO_FLAG = path;
                            ARTIST_TO_FLAG = artistName;
                            SONG_NAME_TO_FLAG = song_name;
                        }
                        else {
                        ...
                        if (SHOW_MINI_PLAYER) {
                            if (PATH_TO_FLAG != null) {
                                ...
                                songName.setText(SONG_NAME_TO_FLAG);
